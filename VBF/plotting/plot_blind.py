...
ggf       = root.Process("GGF H#rightarrowInv",root.kSignal2)
data      = root.Process("Data",root.kData)
processes = [vbf,ggf,qcd,diboson,singletop,ttbar,wewk,zewk,wjets,zjets]
...
if 'pho' in region:
  ...
  ggf.AddFile(baseDir+'GGF_H125.root')
