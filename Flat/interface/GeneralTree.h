...
class GeneralTree : public genericTree {
  ...
  float sf_pho=0;
	float sf_lepTrack=0;
  float sf_sjcsvWeight=0;
  float sf_sjcsvWeightIt=0;
  float sf_csvWeight=0;
  float sf_csvWeightIt=0;
	float sf_btag0=0;
	float sf_btag0BUp=0;
...
void GeneralTree::ReadTree(TTree *t) {
  ...
  treePtr->SetBranchAddress("sf_pho",&sf_pho);
	...
	treePtr->SetBranchStatus("sf_sjcsvWeight",1);
	treePtr->SetBranchAddress("sf_sjcsvWeight",&sf_sjcsvWeight);
	treePtr->SetBranchStatus("sf_sjcsvWeightIt",1);
	treePtr->SetBranchAddress("sf_sjcsvWeightIt",&sf_sjcsvWeightIt);
	treePtr->SetBranchStatus("sf_csvWeight",1);
	treePtr->SetBranchAddress("sf_csvWeight",&sf_csvWeight);
	treePtr->SetBranchStatus("sf_csvWeightIt",1);
	treePtr->SetBranchAddress("sf_csvWeightIt",&sf_csvWeightIt);
...
void GeneralTree::WriteTree(TTree *t) {
  ...
  treePtr->Branch("sf_btag0",&sf_btag0,"sf_btag0/F");
	treePtr->Branch("sf_sjcsvWeight",&sf_sjcsvWeight,"sf_sjcsvWeight/F");
	treePtr->Branch("sf_sjcsvWeightIt",&sf_sjcsvWeightIt,"sf_sjcsvWeightIt/F");
	treePtr->Branch("sf_csvWeight",&sf_csvWeight,"sf_csvWeight/F");
	treePtr->Branch("sf_csvWeightIt",&sf_csvWeightIt,"sf_csvWeightIt/F");
