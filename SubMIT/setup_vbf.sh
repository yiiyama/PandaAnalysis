...
export PANDA_CFG="http://snarayan.web.cern.ch/snarayan/eoscatalog/vbf_20161017.cfg"
export PANDA_FLATDIR="${HOME}/home000/panda/vbf_v1/"
...
export SUBMIT_OUTDIR="/mnt/hadoop/cms/store/user/snarayan/panda/vbf_v1/batch/"
